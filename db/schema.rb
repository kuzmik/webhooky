...
ActiveRecord::Schema[8.1].define(version: 2026_03_18_000001) do
  create_table "tokens", primary_key: "uuid", id: { type: :string, limit: 36 }, force: :cascade do |t|
    ...
    t.text "default_content", default: "", null: false
    t.string "default_content_type", default: "application/json", null: false
    t.integer "default_status", default: 200, null: false
    t.integer "timeout"
